...
function setupResponsiveMenu() {
  ...
  else if (path.includes('report.html')) activeIndex = 2;
  else if (path.includes('tools.html')) activeIndex = 3;
  else if (path.includes('directory.html')) activeIndex = 4;
  ...
  dropdown.innerHTML = `
    <div class="mobile-dropdown-inner">
      ...
      <a href="${pagesPath}report.html" class="mobile-nav-item ${activeIndex === 2 ? 'active' : ''}">
        <span class="mobile-nav-link-content">
      ...
      <a href="${pagesPath}tools.html" class="mobile-nav-item ${activeIndex === 3 ? 'active' : ''}">
        <span class="mobile-nav-link-content">
      ...
      <a href="${pagesPath}directory.html" class="mobile-nav-item ${activeIndex === 4 ? 'active' : ''}">
        <span class="mobile-nav-link-content">

...

{
...

  {
    ...
    reportingGuidance: 'Evidence, screenshots aur payment details ke sath NCCIA/FIA Cyber Crime Portal par complaint register karein.'
  },

  {
    ...
    reportingGuidance: 'Travel agency ki complaint NCCIA/FIA Cyber Crime aur relevant government authorities ke paas register karein.'
  },
...

  {
    ...
    reportingGuidance: 'Don\'t pay! Safe details and screenshots FIA Cyber Crime portal (complaint.ncic.gov.pk) or national harassment helplines par report karein.'
  },

  {
    ...
    reportingGuidance: 'Fake operators details FIA Corporate and Overseas Crimes Wing ko notify karein.'
  },
...

  {
    ...
    reportingGuidance: 'Submit details of fraud systems to PM portal or FIA NCIC portal.'
  },
...

  {
    ...
    reportingGuidance: 'Report fraud numbers and SMS strings to PTA via shortcode 7729.'
  },
...

  {
    ...
    reportingGuidance: 'File complaints with NAB and FIA Corporate Crime Wings.'
  },
...

  {
    ...
    reportingGuidance: 'Submit an incident report directly to Apple Security and file extortion complaints with the FIA Cyber Crime Portal.'
  },
...

  {
    ...
    reportingGuidance: 'Report scam coordinates, phone numbers, and bank accounts to the FIA Cyber Crime Wing.'
  },
...

  {
    ...
    reportingGuidance: 'File complaints with the FIA Cyber Crime Wing under Online Work Scams.'
  },
...

  {
    ...
    reportingGuidance: 'Forward the phishing email to FBR IT support and file a complaint with the FIA Cyber Crime portal.'
  },
...

  {
    ...
    reportingGuidance: 'Report the number to NADRA support and the FIA Cyber Crime Wing.'
  },
...

  {
    ...
    reportingGuidance: 'Submit a complaint to the Bureau of Emigration and report the agent to the FIA Cyber Crime/Human Trafficking wing.'
  },
...

  {
    ...
    reportingGuidance: 'Report fake charity profiles to the PTA and the FIA Cyber Crime division.'
  },
...

  {
    ...
    reportingGuidance: 'Report the travel scammer to the FIA Cyber Crime Wing and the Civil Aviation Authority (CAA).'
  },
  ...
  // 2. Under-Invoice Import Scams
  {
    ...
    reportingGuidance: 'Report customs scam calls and blackmailing attempts to the FBR helpline and the FIA Cyber Crime Wing.'
  },
  ...
  // 3. Fake Government Ehsaas Program Cash Offers
  {
    ...
    reportingGuidance: 'Report fake Ehsaas/BISP scam messages by forwarding the sender number to the BISP helpline and PTA shortcode 7729.'
  },
  ...
  // 4. Cryptocurrency Investment Scams and Fake Arbitrage Bots
  {
    ...
    reportingGuidance: 'Report illegal digital asset operators and fraudulent investment platforms to the SECP and FIA Cyber Crime Wing.'
  },
  ...
  // 6. Fake Medical Emergency and Hospital Bill Appeals
  {
    ...
    reportingGuidance: 'Report fake medical charity profiles and fraudulent fund-raisers to the relevant social media platform and the FIA Cyber Crime division.'
  },
  ...
  // 17. Work from Home Typing and CAPTCHA Solving Fraud
  {
    ...
    reportingGuidance: 'Report these fake recruitment agencies and pages to the FIA Cyber Crime division.'
  },
  ...
  // 27. Telegram Micro-Task & Rating Scams
  {
    ...
    reportingGuidance: 'Block scam numbers, report Telegram channels, and submit transaction receipts to FIA Cyber Crime.'
  },
  ...
  // 31. Business Email Compromise (BEC) & Vendor Wire Fraud
  {
    ...
    reportingGuidance: 'Notify paying and receiving banks immediately to freeze funds, and file a report with FIA Cyber Crime Wing.'
  },
  ...
  // 33. Fake University Degree & Unaccredited Certification Scams
  {
    ...
    reportingGuidance: 'Report fake degree sellers and diploma mills to HEC and FIA Cyber Crime Wing.'
  },
  ...
  // 38. Romance Scams & Digital Catfishing Extortion
  {
    ...
    reportingGuidance: 'Do not pay blackmailers. Report online harassment and extortion immediately to the FIA Cyber Crime Wing.'
  },
...
,
  ...
  {
    id: "voice-cloning-ai-scams",
    title: "AI Voice Cloning Emergency Scams (Fake Kidnapping & Family Crisis Audio Calls)",
    category: "Emerging Threats",
    iconName: "mic",
    overview: "<div class=\"article-rich-content\">\n      <h3>1. Understanding AI Voice Cloning Scams in Pakistan</h3>\n      <p>Artificial Intelligence (AI) voice cloning technology allows cybercriminals to replicate a person's exact voice, speech pitch, and accent using just a 5-second audio clip scraped from social media videos, voice notes, or public calls. In Pakistan, scammers use voice clones to call parents, spouses, or relatives, pretending that a family member has met with an accident, been arrested by police, or kidnapped, demanding immediate cash transfers via Easypaisa or JazzCash.</p>\n      <h3>2. How an AI Voice Cloning Attack Unfolds</h3>\n      <ol>\n        <li><strong>Step 1: Voice Harvesting:</strong> Scammers harvest short video clips or audio notes posted publicly on TikTok, Instagram, or Facebook.</li>\n        <li><strong>Step 2: Voice Model Generation:</strong> AI software generates a realistic voice clone capable of speaking any custom script in Urdu or English.</li>\n        <li><strong>Step 3: Panic Emergency Call:</strong> The victim receives a distressed call sounding exactly like their child or relative begging for urgent financial help.</li>\n        <li><strong>Step 4: Fake Official Demand:</strong> An impersonator claiming to be a hospital doctor or police officer takes over the call, demanding immediate mobile wallet transfers.</li>\n      </ol>\n      <h3>3. Warning Signs and Red Flags</h3>\n      <ul>\n        <li>Calls coming from unknown or temporary mobile numbers despite the voice matching your family member.</li>\n        <li>Extreme background noise (crying, sirens) designed to suppress clear audio analysis.</li>\n        <li>Demands for immediate money via Easypaisa, JazzCash, or bank transfer without allowing you to hang up.</li>\n      </ul>\n      <h3>4. How to Protect Yourself</h3>\n      <ul>\n        <li>Set up a secret family passcode or codeword to verify identity during sudden emergency calls.</li>\n        <li>Hang up and directly call your family member on their official cellular phone number or WhatsApp.</li>\n        <li>Avoid posting long public voice notes or videos with clear solo speech on open social media profiles.</li>\n      </ul>\n      <h3>5. Frequently Asked Questions (FAQs)</h3>\n      <p><strong>Q: Can AI duplicate Urdu regional accents accurately?</strong><br>A: Yes, modern generative audio models can clone regional accents, emotional tone, and speech cadence with remarkable accuracy.</p>\n      <p><strong>Q: What should I do if the caller refuses to let me hang up?</strong><br>A: Mute your microphone and try contacting the family member using another phone, or ask them a private personal question only the real person would know.</p>\n      <h3>6. Key Takeaways</h3>\n      <table class=\"checklist-table\" style=\"width: 100%; border-collapse: collapse; margin-top: 1rem;\">\n        <thead><tr style=\"background-color: var(--bg-secondary); border-bottom: 2px solid var(--border-color);\"><th style=\"padding: 0.5rem; text-align: left;\">Action Item</th><th style=\"padding: 0.5rem; text-align: left;\">Status</th></tr></thead>\n        <tbody>\n          <tr style=\"border-bottom: 1px solid var(--border-color);\"><td style=\"padding: 0.5rem;\">Establish a confidential family emergency passcode.</td><td style=\"padding: 0.5rem; color: var(--color-success);\">✔ Essential</td></tr>\n          <tr style=\"border-bottom: 1px solid var(--border-color);\"><td style=\"padding: 0.5rem;\">Always verify emergencies by directly calling the relative's official phone.</td><td style=\"padding: 0.5rem; color: var(--color-success);\">✔ Critical</td></tr>\n        </tbody>\n      </table>\n    </div>",
    warningSigns: [
      "Call from an unrecognized number claiming to be a family member in distress.",
      "Refusal to allow you to disconnect or verify with other family members.",
      "Demands for immediate cash transfer via mobile wallets."
],
    examples: [
      "A father in Lahore received a call sounding identically like his daughter in university claiming she was detained in an accident, demanding Rs. 50,000 immediately."
],
    preventionTips: [
      "Always hang up and call the real person directly.",
      "Ask a specific personal question that an AI voice model cannot answer.",
      "Never transfer money under panic pressure."
],
    reportingGuidance: "Report AI voice cloning extortion calls immediately to NCCIA Helpline 1799 and notify your local police station."
  },

  {
    id: "fake-solar-panel-installers",
    title: "Fake Solar System Net-Metering & Government Subsidy Schemes",
    category: "E-Commerce & Delivery",
    iconName: "sun",
    overview: "<div class=\"article-rich-content\">\n      <h3>1. Solar Energy Fraud in Pakistan</h3>\n      <p>With rising electricity tariffs across Pakistan, solar energy adoption has skyrocketed. Fraudulent contractors and fake social media pages promise subsidized solar panels, rapid net-metering approvals from DISCOs (LESCO, K-Electric, IESCO, FESCO), and Grade-A inverter imports at 50% market prices, absconding after receiving advance deposits.</p>\n      <h3>2. How the Solar Scam Operates</h3>\n      <ol>\n        <li>Fictitious Facebook and Instagram advertisements offer \"Government Subsidized Solar Packages\" or \"Guaranteed 3-Day Net Metering License.\"</li>\n        <li>Scammers collect advance booking fees (20%-50%) via online bank transfers.</li>\n        <li>Substandard, refurbished, or B-grade solar panels with altered serial numbers are delivered, or the contractor disappears completely.</li>\n      </ol>\n      <h3>3. Protection and Verification</h3>\n      <ul>\n        <li>Verify solar vendors through AEDB (Alternative Energy Development Board) certified installer lists.</li>\n        <li>Pay through crossed bank cheques linked to registered corporate business accounts rather than personal mobile wallet accounts.</li>\n        <li>Cross-check net-metering application reference numbers directly with your official electric distribution company portal.</li>\n      </ul>\n      <h3>4. Key Takeaways</h3>\n      <p>Only engage AEDB-registered vendors and never deposit upfront payments into unverified personal accounts.</p>\n    </div>",
    warningSigns: [
      "Offers of solar panel packages at unrealistically low prices.",
      "Demands for full or 50% advance cash deposits via personal mobile accounts.",
      "Lack of a physical office address or AEDB registration."
],
    examples: [
      "An online ad promised a 10kW solar system with K-Electric net metering for Rs. 400,000. After transferring Rs. 150,000 advance, the seller blocked all calls."
],
    preventionTips: [
      "Verify contractor AEDB certification status before signing agreements.",
      "Inspect solar panel barcode authenticity on official manufacturer portals.",
      "Pay via crossed business cheques in stages after hardware delivery."
],
    reportingGuidance: "File complaints against fraudulent solar contractors with NEPRA, Punjab/Sindh Consumer Courts, and NCCIA 1799."
  },

  {
    id: "gold-investment-app-frauds",
    title: "Digital Gold & Precious Metals Trading App Traps",
    category: "Financial & Banking",
    iconName: "coins",
    overview: "<div class=\"article-rich-content\">\n      <h3>1. Digital Gold Scams Explained</h3>\n      <p>Unregulated mobile applications and Telegram bots target investors in Pakistan by promising fixed daily returns on \"Digital Gold\", \"Raw Bullion Trading\", or \"Precious Metal Mining Schemes\". These operations function as classic Ponzi schemes that block withdrawals once a critical deposit threshold is reached.</p>\n      <h3>2. Warning Signs and Red Flags</h3>\n      <ul>\n        <li>Guaranteed daily profit margins (e.g. 2% to 5% daily return on gold reserves).</li>\n        <li>Lack of SECP (Securities and Exchange Commission of Pakistan) licensing for digital asset management.</li>\n        <li>Deposits accepted exclusively via USDT, Easypaisa, or unverified personal bank accounts.</li>\n      </ul>\n      <h3>3. Safe Investment Guidelines</h3>\n      <p>Verify all financial institutions and trading brokers on the official SECP licensing portal before investing in digital commodity instruments.</p>\n    </div>",
    warningSigns: [
      "Promises of risk-free daily returns on gold purchases.",
      "Requests for funds via unverified peer-to-peer crypto transfers.",
      "High commissions offered for recruiting friends and family."
],
    examples: [
      "An app called \"Pak Gold Reserve\" offered 3% daily returns on gold ounces. Thousands deposited savings before the app server went offline."
],
    preventionTips: [
      "Check SECP corporate registration and licensed broker lists.",
      "Never trust investment schemes promising guaranteed high returns.",
      "Avoid unverified APK file downloads for trading apps."
],
    reportingGuidance: "Report illegal investment apps and Ponzi schemes to SECP and NCCIA Cyber Crime Helpline 1799."
  },

  {
    id: "freelance-upwork-off-platform-scams",
    title: "Freelancer Off-Platform Direct Payment & Escrow Bypass Scams",
    category: "Urgent Threats",
    iconName: "briefcase",
    overview: "<div class=\"article-rich-content\">\n      <h3>1. Targeting Pakistani Freelancers</h3>\n      <p>Pakistani freelancers on platforms like Upwork, Fiverr, and LinkedIn are frequently targeted by clients demanding to move communication to Telegram or WhatsApp. These scammers trick freelancers into completing large assignments, submitting fraudulent check payments, or paying \"client registration / software license fees\" before disappearing.</p>\n      <h3>2. Common Tactics</h3>\n      <ul>\n        <li>Off-platform contract offers with promises of higher hourly pay.</li>\n        <li>Fake payment screenshots from Payoneer or Wise requiring a \"security fee\" to release international funds.</li>\n        <li>Requesting freelancers to download custom project files containing infostealer Trojans.</li>\n      </ul>\n      <h3>3. Protection Guidelines</h3>\n      <p>Always maintain project communication and milestone escrow payments strictly inside official freelancing platforms.</p>\n    </div>",
    warningSigns: [
      "Clients insisting on leaving Upwork/Fiverr before contract approval.",
      "Requests to pay upfront fees for project setup materials.",
      "Receiving executable files (.exe, .scr) disguised as project briefs."
],
    examples: [
      "A graphic designer was offered $2,000 for a logo project on Telegram but was asked to pay a $50 \"Payoneer clearing fee\" first. The client disappeared after receiving money."
],
    preventionTips: [
      "Keep all work, messages, and payments on platform.",
      "Never pay a client to receive work or project assignments.",
      "Scan all received files with updated antivirus software."
],
    reportingGuidance: "Report scam clients to Upwork/Fiverr Trust & Safety and log cyber fraud incidents with NCCIA 1799."
  },

  {
    id: "malicious-qr-code-parking-bills",
    title: "Malicious Parking & Municipal Fee QR Code Phishing",
    category: "E-Commerce & Delivery",
    iconName: "qr-code",
    overview: "<div class=\"article-rich-content\">\n      <h3>1. Quishing at Public Parking & Municipal Sites</h3>\n      <p>Scammers place physical sticker overlays containing malicious QR codes over official municipal parking fee boards, toll plaza signs, or utility bill payment notices. Scanning these QR codes directs citizens to fake phishing portals that harvest credit card and mobile wallet credentials.</p>\n      <h3>2. Defense Checklist</h3>\n      <ul>\n        <li>Inspect physical QR code signs for sticker overlays or tampering.</li>\n        <li>Verify the destination domain in your mobile browser before submitting payment credentials.</li>\n        <li>Prefer using official municipal apps (e.g., e-Pay Punjab, e-Khidmat) rather than scanning random outdoor stickers.</li>\n      </ul>\n    </div>",
    warningSigns: [
      "Physical QR stickers pasted clumsily over official printed boards.",
      "Payment links directing to non-government domains without SSL certificates.",
      "Requests for banking passwords or card PINs during parking fee payment."
],
    examples: [
      "A driver scanned a QR code sticker on a parking meter in Islamabad. The link opened a fake gateway that stole Rs. 15,000 from his debit card."
],
    preventionTips: [
      "Check QR stickers for visual signs of physical tampering.",
      "Always check the address bar before entering payment details.",
      "Use official government apps like e-Pay Punjab directly."
],
    reportingGuidance: "Report tampered public QR codes to municipal authorities and NCCIA 1799."
  },

  {
    id: "bank-branch-impersonation-doorstep",
    title: "Fake Bank Representative Doorstep Cash & Card Collection Traps",
    category: "Financial & Banking",
    iconName: "user-x",
    overview: "<div class=\"article-rich-content\">\n      <h3>1. Home Visit Banking Scams</h3>\n      <p>Scammers call bank customers posing as branch managers or audit officers, claiming their ATM card requires mandatory chip replacement or verification. A fake rider or representative arrives at the customer's home to collect the old card, PIN, or cash deposit, leading to immediate account drain.</p>\n      <h3>2. Key Protection Rules</h3>\n      <p>Pakistani commercial banks NEVER dispatch riders to collect ATM cards, chequebooks, or cash from customer residences under any circumstances.</p>\n    </div>",
    warningSigns: [
      "Calls offering doorstep ATM card replacement or upgrade services.",
      "Riders asking for card PINs or CVV numbers on paper slips.",
      "Urgency created regarding account closure or frozen funds."
],
    examples: [
      "An elderly citizen in Karachi handed over his debit card to a fake rider claiming to represent HBL. The card was used at an ATM within 15 minutes."
],
    preventionTips: [
      "Never hand over debit/credit cards or PINs to anyone at your home.",
      "Visit your official local bank branch in person for card upgrades.",
      "Report fake bank calls to your official bank helpline immediately."
],
    reportingGuidance: "Call your official bank helpline immediately to block compromised cards, and lodge a complaint with NCCIA 1799."
  },

  {
    id: "car-rental-booking-frauds",
    title: "Fake Online Car Rental & Fleet Advance Booking Scams",
    category: "E-Commerce & Delivery",
    iconName: "car",
    overview: "<div class=\"article-rich-content\">\n      <h3>1. Wedding & Travel Rental Scams</h3>\n      <p>Fake car rental pages on Facebook and OLX offer luxury vehicles, SUVs, and wedding cars at discounted rates. Scammers request 50% booking advances via Easypaisa, send fake vehicle registration photos, and turn off their phones on the day of the event.</p>\n      <h3>2. Protection Steps</h3>\n      <ul>\n        <li>Inspect the physical vehicle and rental office location in person before paying booking advances.</li>\n        <li>Demand written rental contracts on official business letterhead with CNIC copies of the owner.</li>\n      </ul>\n    </div>",
    warningSigns: [
      "Rental prices significantly lower than prevailing market rates.",
      "Insistence on cash or mobile wallet advances before vehicle inspection.",
      "Absence of a verifiable physical garage or office address."
],
    examples: [
      "A family booked a Prado for a wedding trip via Facebook, sending Rs. 30,000 advance. No car arrived on the wedding day, and the page was deleted."
],
    preventionTips: [
      "Visit the rental showroom in person to verify vehicles.",
      "Pay via bank channels with stamped business receipts.",
      "Cross-check rental company reviews and physical location on Google Maps."
],
    reportingGuidance: "File fraud reports with local police and NCCIA Cyber Crime Helpline 1799."
  },

  {
    id: "fake-job-visa-medical-tests",
    title: "Fake Overseas Medical Center Appointment Booking Portals",
    category: "Identity & Telecom",
    iconName: "activity",
    overview: "<div class=\"article-rich-content\">\n      <h3>1. Targeting Overseas Job Seekers</h3>\n      <p>Pakistani workers applying for jobs in Gulf countries (Saudi Arabia, UAE, Qatar) are targeted by fake GAMCA/WAFID medical appointment portals. These malicious sites copy official government layouts and steal debit card credentials under the guise of charging medical test appointment fees.</p>\n      <h3>2. Official Verification Channel</h3>\n      <p>Only book GAMCA/WAFID medical slips through the single verified portal: <code>wafid.com</code>. Avoid sponsored search engine links.</p>\n    </div>",
    warningSigns: [
      "Sponsored Google Search ads pointing to domains like \"gamcamedical-pk.org\".",
      "Exorbitant appointment booking fees charged in foreign currencies.",
      "Requests for full passport scan downloads on unencrypted sites."
],
    examples: [
      "A candidate bound for Saudi Arabia paid Rs. 12,000 on a fake medical portal. The slip was rejected by the approved medical center in Rawalpindi."
],
    preventionTips: [
      "Type official domains directly into your browser URL bar.",
      "Verify approved medical centers on the official Ministry of Overseas Pakistanis website.",
      "Never use unverified third-party visa agents."
],
    reportingGuidance: "Report fake visa medical portals to the Overseas Pakistanis Foundation (OPF) and NCCIA 1799."
  },

  {
    id: "crypto-wallet-seed-phrase-drainers",
    title: "Web3 Crypto Wallet Seed Phrase Theft & Browser Drainers",
    category: "Emerging Threats",
    iconName: "key",
    overview: "<div class=\"article-rich-content\">\n      <h3>1. Web3 Asset Drainers</h3>\n      <p>Pakistani crypto traders using MetaMask, Trust Wallet, or Phantom are targeted by malicious browser extensions, fake air-drop websites, and Telegram support bots designed to steal 12/24-word recovery seed phrases and automatically drain wallet funds.</p>\n      <h3>2. Security Rules</h3>\n      <ul>\n        <li>NEVER type your seed phrase into any website, Google Form, or customer support chat window.</li>\n        <li>Store seed phrases offline on physical paper or hardware cold wallets.</li>\n      </ul>\n    </div>",
    warningSigns: [
      "Websites asking for your 12-word seed phrase to \"synchronize\" or \"verify\" your wallet.",
      "Unsolicited direct messages from \"Support Representatives\" on Telegram or Discord.",
      "Airdrop sites requesting unlimited smart contract token approval."
],
    examples: [
      "A trader entered his 12-word recovery phrase on a fake MetaMask support page. Within seconds, $4,000 in USDT was transferred to an offshore wallet."
],
    preventionTips: [
      "Never digitalize or screenshot your seed phrase.",
      "Use hardware wallets for storing significant crypto assets.",
      "Revoke suspicious smart contract approvals regularly via Revoke.cash."
],
    reportingGuidance: "Report web3 phishing domains to Google Safe Browsing and log cyber incidents with NCCIA 1799."
  },

  {
    id: "e-commerce-return-refund-fraud",
    title: "E-Commerce Courier Fake Return Refund Verification Calls",
    category: "E-Commerce & Delivery",
    iconName: "package-x",
    overview: "<div class=\"article-rich-content\">\n      <h3>1. Fake Refund Verification Phishing</h3>\n      <p>Scammers pose as courier agents (Leopard, TCS, CallCourier) or Daraz customer care officers calling regarding a returned order. They claim a refund of Rs. 2,000 is ready but require you to approve a \"bank verification link\" or share an OTP, which actually authorizes a withdrawal from your bank or wallet.</p>\n      <h3>2. Safety Rule</h3>\n      <p>E-commerce refunds are processed automatically back to your original payment method. Legitimate couriers never ask for OTPs or PIN numbers to process returns.</p>\n    </div>",
    warningSigns: [
      "Calls requesting an OTP to release order return money.",
      "Receiving phishing payment approval links via WhatsApp.",
      "Callers threatening to forfeit refund money if not acted on in 5 minutes."
],
    examples: [
      "A buyer expecting a Daraz refund shared an OTP sent by a caller claiming to be a TCS manager. Instead of receiving Rs. 1,500, Rs. 35,000 was debited."
],
    preventionTips: [
      "Check return refund status directly inside official e-commerce apps.",
      "Never share OTPs with courier delivery drivers or callers.",
      "Contact official courier customer support for parcel queries."
],
    reportingGuidance: "Report fraudulent courier calls to your bank to block transactions and file a case with NCCIA 1799."
  },

  {
    id: "fake-tenders-procurement-scams",
    title: "Government & Corporate Procurement Fake Tender Bidding Traps",
    category: "Corporate & Cloud",
    iconName: "file-text",
    overview: "<div class=\"article-rich-content\">\n      <h3>1. Procurement Fraud in Pakistan</h3>\n      <p>Small contractors and vendors are targeted by fake government procurement portals imitating PPRA (Public Procurement Regulatory Authority), CWD, or military works departments. Scammers demand non-refundable tender document processing fees (Rs. 25,000 to Rs. 100,000) for fake supply contracts.</p>\n      <h3>2. Verification Measures</h3>\n      <p>Always verify active tenders on official government department domain portals (ending in <code>.gov.pk</code> or <code>ppra.org.pk</code>).</p>\n    </div>",
    warningSigns: [
      "Tender notices received via WhatsApp from personal mobile numbers.",
      "Requests to deposit tender document fees into personal bank accounts.",
      "Guaranteed award of contract promised in exchange for advance kickbacks."
],
    examples: [
      "A IT vendor deposited Rs. 50,000 for a fake university computer equipment tender sent via email. The university confirmed no such tender existed."
],
    preventionTips: [
      "Verify tenders directly on official PPRA and government department portals.",
      "Pay tender fees only via official bank pay orders drawn in favor of government treasuries.",
      "Never pay kickbacks or commissions to unverified intermediaries."
],
    reportingGuidance: "Report procurement scams to PPRA, NAB, and NCCIA Cyber Crime Helpline 1799."
  },

  {
    id: "subdomain-takeover-attacks",
    title: "Subdomain Takeover & Forgotten Cloud Resource Exploits",
    category: "Corporate & Cloud",
    iconName: "globe",
    overview: "<div class=\"article-rich-content\">\n      <h3>1. Subdomain Takeover Mechanics</h3>\n      <p>Subdomain takeover occurs when an organization points a CNAME DNS record (e.g. <code>promo.company.com.pk</code>) to an external cloud service (AWS S3, GitHub Pages, Azure) that has been decommissioned without removing the DNS record. Attackers claim the abandoned cloud destination and host malicious phishing content on the organization's legitimate subdomain.</p>\n      <h3>2. Organizational Remediation</h3>\n      <ul>\n        <li>Maintain a centralized inventory of all public DNS CNAME records and active cloud resources.</li>\n        <li>Immediately delete DNS CNAME entries when decommissioning third-party SaaS services.</li>\n      </ul>\n    </div>",
    warningSigns: [
      "Company subdomains serving unexpected third-party default 404 pages.",
      "Orphaned CNAME records pointing to expired S3 buckets or Heroku apps."
],
    examples: [
      "An abandoned marketing subdomain of a local bank was hijacked by attackers to host a phishing form that looked 100% legitimate due to the bank's SSL certificate."
],
    preventionTips: [
      "Run regular automated subdomain takeover scanning tools (e.g., Subjack).",
      "Audit DNS records during cloud infrastructure updates.",
      "Enforce zero-trust DNS lifecycle management."
],
    reportingGuidance: "Report discovered vulnerable corporate subdomains immediately to the organization's Security Operations Center (SOC)."
  },

  {
    id: "fake-antivirus-tech-support-popups",
    title: "Tech Support Browser Lock Popups & Fake Antivirus Subscriptions",
    category: "Emerging Threats",
    iconName: "monitor-x",
    overview: "<div class=\"article-rich-content\">\n      <h3>1. Browser Hijack Tech Support Scams</h3>\n      <p>Users navigating local movie, torrent, or news portals encounter full-screen browser popups claiming: \"YOUR COMPUTER IS INFECTED WITH TROJAN VIRUS! CALL PAKISTAN TOLL FREE SUPPORT IMMEDIATELY.\" The popup triggers loud audio alarms and locks the browser window to force victims into calling fraudulent call centers.</p>\n      <h3>2. How to Unlock Your Browser</h3>\n      <p>Do NOT call the phone number. Press <code>CTRL + ALT + DEL</code> (or <code>ESC</code> / Task Manager) and force-close your web browser process.</p>\n    </div>",
    warningSigns: [
      "Sudden full-screen browser lockup with loud alert sounds.",
      "Unrecognized helpline numbers demanding remote access via AnyDesk.",
      "Claims that Windows/McAfee subscription has expired and credit card renewal is urgent."
],
    examples: [
      "A user called a pop-up helpline number and allowed a scammer remote access. The scammer charged $300 on his credit card for \"cleaning non-existent malware.\""
],
    preventionTips: [
      "Force close the browser process using Task Manager.",
      "Never grant remote desktop access (AnyDesk/TeamViewer) to popup callers.",
      "Install an effective ad-blocker extension like uBlock Origin."
],
    reportingGuidance: "Report tech support scam call centers to NCCIA Helpline 1799."
  },

  {
    id: "whatsapp-channel-admin-scams",
    title: "WhatsApp Broadcast Channel Admin Hijacking & Paid Signal Traps",
    category: "Social & Gaming",
    iconName: "message-square",
    overview: "<div class=\"article-rich-content\">\n      <h3>1. WhatsApp Channel Exploitation</h3>\n      <p>With WhatsApp Channels becoming popular in Pakistan for news and crypto signals, scammers hijack channel admin privileges using session cookie theft or trick creators into sharing channel ownership. They then blast fake investment links and crypto pump-and-dump schemes to thousands of subscribers.</p>\n      <h3>2. Channel Security Steps</h3>\n      <ul>\n        <li>Enforce Two-Step Verification on all WhatsApp accounts holding Channel Admin rights.</li>\n        <li>Never add unknown accounts as Channel Co-Admins or Transfer Channel Ownership.</li>\n      </ul>\n    </div>",
    warningSigns: [
      "Sudden promotion of guaranteed crypto trading signals or gambling apps in trusted channels.",
      "Unsolicited offers to buy or sponsor your WhatsApp channel.",
      "Requests to install \"Channel Analytics APKs\"."
],
    examples: [
      "A tech channel with 40,000 followers was hijacked after the admin transferred rights to a buyer who used fake payment receipts. The channel was used to launch a crypto scam."
],
    preventionTips: [
      "Enable 2FA PIN on WhatsApp.",
      "Strictly vet all channel co-admins.",
      "Never click suspicious verification links sent via WhatsApp DMs."
],
    reportingGuidance: "Report hijacked WhatsApp channels through the in-app \"Report Channel\" button and notify NCCIA 1799."
  },

  {
    id: "fake-law-enforcement-warrants",
    title: "Fake Court Summons & Digital Police Arrest Notice Emails",
    category: "Urgent Threats",
    iconName: "file-warning",
    overview: "<div class=\"article-rich-content\">\n      <h3>1. Digital Intimidation Scams</h3>\n      <p>Citizens receive official-looking PDF emails or WhatsApp messages containing fake court arrest warrants, FIA investigation notices, or customs violation warnings. The documents threaten immediate arrest within 24 hours unless a \"pre-trial settlement fine\" is paid electronically.</p>\n      <h3>2. Legal Reality</h3>\n      <p>Pakistani courts, FIA, and police departments do NOT issue arrest warrants via WhatsApp or demand fine settlements through private mobile wallet numbers.</p>\n    </div>",
    warningSigns: [
      "Arrest notices delivered via WhatsApp or Gmail addresses.",
      "Demand to pay fines into personal bank or Easypaisa accounts.",
      "Spelling errors and altered official seals on PDF documents."
],
    examples: [
      "A shopkeeper received a fake \"Supreme Court Violation Warrant\" demanding Rs. 80,000 fine via JazzCash to stop police raid teams. He verified with a lawyer and avoided the trap."
],
    preventionTips: [
      "Verify official legal notices in person at your local police station or court registry.",
      "Never transfer money to personal mobile numbers for legal settlements.",
      "Inspect sender email domains carefully."
],
    reportingGuidance: "Report extortion notices involving forged law enforcement seals directly to NCCIA 1799."
  },

  {
    id: "airline-frequent-flyer-miles-theft",
    title: "Airline Miles & Loyalty Account Credential Stuffing",
    category: "E-Commerce & Delivery",
    iconName: "plane",
    overview: "<div class=\"article-rich-content\">\n      <h3>1. Loyalty Points Hijacking</h3>\n      <p>Cybercriminals use credential stuffing automated tools to breach airline loyalty accounts (PIA Awards, Emirates Skywards, Etihad Guest). Accumulated frequent flyer miles are redeemed for ticket purchases or transferred to black-market brokers.</p>\n      <h3>2. Protection Guidelines</h3>\n      <p>Use unique passwords for airline reward accounts and enable multi-factor authentication across all travel profiles.</p>\n    </div>",
    warningSigns: [
      "Unsolicited SMS notifications for reward point redemptions.",
      "Inability to log into your airline loyalty account.",
      "Emails confirming flight bookings you never made."
],
    examples: [
      "A frequent traveler discovered 120,000 accumulated airline miles were drained to issue flight tickets in another person's name due to password reuse."
],
    preventionTips: [
      "Never reuse passwords across different online services.",
      "Monitor loyalty point balance statements regularly.",
      "Set strong 16+ character passwords for travel portals."
],
    reportingGuidance: "Contact airline customer service immediately to freeze account activity and log incident details."
  },

  {
    id: "fake-real-estate-rentals-airbnb",
    title: "Fake Online Property Rental Listings & Advance Rent Scams",
    category: "E-Commerce & Delivery",
    iconName: "home",
    overview: "<div class=\"article-rich-content\">\n      <h3>1. Real Estate Rental Scams</h3>\n      <p>Fake property listings on Zameen.com, OLX, or Facebook feature photos of luxury apartments in DHA, Bahria Town, or Gulberg at heavily discounted rent. Scammers claim the landlord is overseas and require a \"security deposit / token money\" before allowing physical keys or house visits.</p>\n      <h3>2. Protection Checklist</h3>\n      <p>NEVER pay token money or advance rent without visiting the property in person and verifying original ownership documents with the society management office.</p>\n    </div>",
    warningSigns: [
      "Landlord claims to be living abroad and unavailable for physical property showing.",
      "Rental price 40% lower than prevailing market rates in the sector.",
      "Demands for token money transferred to personal mobile wallets before physical visits."
],
    examples: [
      "A student sent Rs. 25,000 token money for an apartment in Islamabad. Upon reaching the building, the actual owner revealed the photos were stolen from another listing."
],
    preventionTips: [
      "Always visit the property and meet the landlord or registered estate agent in person.",
      "Verify ownership papers at the society transfer office.",
      "Pay token money only against official signed legal receipts."
],
    reportingGuidance: "Lodge real estate fraud complaints with local police and NCCIA Cyber Crime Helpline 1799."
  },

  {
    id: "malicious-pdf-invoice-exploits",
    title: "Malicious PDF Invoice Attachments & Zero-Day PDF Viewers",
    category: "Corporate & Cloud",
    iconName: "file-code",
    overview: "<div class=\"article-rich-content\">\n      <h3>1. Weaponized PDF Documents</h3>\n      <p>Cybercriminals send corporate accounts departments malicious PDF invoices containing embedded JavaScript exploits or phishing links. Opening the PDF executes hidden payload scripts that compromise local memory or redirect users to credential harvesting portals.</p>\n      <h3>2. Corporate Defense</h3>\n      <ul>\n        <li>Disable JavaScript execution inside desktop PDF readers (Adobe Acrobat Settings).</li>\n        <li>Use secure cloud-based email sandboxing to inspect incoming PDF attachments.</li>\n      </ul>\n    </div>",
    warningSigns: [
      "Unsolicited invoice emails from unknown international vendor domains.",
      "PDF documents prompting you to enable JavaScript or click embedded links.",
      "Invoices asking for immediate payment to altered bank account details."
],
    examples: [
      "An accountant opened a \"Tax Invoice.pdf\" attachment that executed an infostealer script, stealing saved browser banking session cookies."
],
    preventionTips: [
      "Disable JavaScript in PDF readers.",
      "Verify invoice payment detail changes directly via phone call with vendor management.",
      "Keep PDF reader software updated."
],
    reportingGuidance: "Report corporate malware attempts to your internal IT Security team and NCCIA 1799."
  },

  {
    id: "unauthorized-pos-machine-tampering",
    title: "Point-of-Sale (POS) Merchant Terminal Hardware Tampering",
    category: "Financial & Banking",
    iconName: "credit-card",
    overview: "<div class=\"article-rich-content\">\n      <h3>1. POS Hardware Skimming</h3>\n      <p>Criminals install physical hardware shimmers or modified firmware inside point-of-sale card terminals in restaurants, fuel stations, and retail outlets. When customers swipe or dip their credit/debit cards, magnetic stripe data and PIN entries are secretly recorded and transmitted wirelessly.</p>\n      <h3>2. Consumer Vigilance</h3>\n      <ul>\n        <li>Always cover the PIN keypad with your hand when typing your card PIN at retail counters.</li>\n        <li>Prefer Contactless Tap-to-Pay payments over physical card dipping/swiping.</li>\n        <li>Inspect POS machine casing for loose components or secondary card readers.</li>\n      </ul>\n    </div>",
    warningSigns: [
      "POS machine appears unusually bulky or has loose plastic casings.",
      "Cashier insists on swiping the magnetic stripe instead of using EMV chip/tap.",
      "PIN keypad buttons feel spongy or raised abnormally."
],
    examples: [
      "A cardholder's credit card was cloned after paying at an unverified roadside restaurant where an employee used a tampered POS machine."
],
    preventionTips: [
      "Use contactless NFC payments (Tap) whenever possible.",
      "Always hide PIN entry with your hand.",
      "Enable instant SMS alerts for all debit/credit card transactions."
],
    reportingGuidance: "Report suspect POS merchant terminals to your bank helpline and NCCIA 1799."
  },

  {
    id: "fake-charity-zakat-portals",
    title: "Ramadan Zakat & Fitrana Fake Digital Donation Portals",
    category: "Urgent Threats",
    iconName: "heart-handshake",
    overview: "<div class=\"article-rich-content\">\n      <h3>1. Exploiting Charitable Giving</h3>\n      <p>During holy months like Ramadan and Eid, scammers set up fake charity websites, social media pages, and WhatsApp donation drives mimicking recognized Pakistani NGOs (Edhi Foundation, Saylani Welfare, Indus Hospital, Shaukat Khanum). Donated funds are diverted into fraudster accounts.</p>\n      <h3>2. Verification Measures</h3>\n      <p>Donate strictly through official verified NGO domain websites ending in official merchant payment gateways, or direct bank accounts listed on published official annual reports.</p>\n    </div>",
    warningSigns: [
      "Donation requests asking for transfers to personal Easypaisa/JazzCash numbers instead of official corporate NGO accounts.",
      "Social media pages with altered NGO logos and recent creation dates.",
      "Unsolicited WhatsApp messages promising guaranteed 100% distribution without proof."
],
    examples: [
      "A donor sent Rs. 50,000 Zakat to a WhatsApp group claiming to collect for flood relief. The group admins disappeared after receiving funds."
],
    preventionTips: [
      "Verify official NGO bank account titles before transferring money.",
      "Donate directly through official charity mobile apps or official website portals.",
      "Request official stamped tax exemption receipts for major contributions."
],
    reportingGuidance: "Report fake charity profiles to the Pakistan Centre for Philanthropy (PCP) and NCCIA 1799."
  },

  {
    id: "smart-meter-tampering-scams",
    title: "Smart Electricity Meter Verification & Power Disconnection Scams",
    category: "Identity & Telecom",
    iconName: "zap",
    overview: "<div class=\"article-rich-content\">\n      <h3>1. Electricity Disconnection Threat Calls</h3>\n      <p>Consumers across Pakistan receive automated phone calls or SMS messages claiming: \"YOUR ELECTRICITY SMART METER WILL BE PERMANENTLY DISCONNECTED TONIGHT AT 10 PM DUE TO UNPAID BILL. CALL SUB-DIVISION OFFICER IMMEDIATELY.\" The caller demands immediate payment via personal mobile transfer to halt disconnection.</p>\n      <h3>2. Power Distribution Rules</h3>\n      <p>Official electric distribution companies (LESCO, K-Electric, FESCO, IESCO, MEPCO) issue bill notices on paper bills and official shortcodes, never requesting bill payments to personal mobile wallet accounts.</p>\n    </div>",
    warningSigns: [
      "SMS threatening electricity disconnection sent from ordinary 11-digit mobile numbers.",
      "Demand to pay utility bills into personal mobile wallets.",
      "Calls received outside official office working hours."
],
    examples: [
      "A shopkeeper transferred Rs. 18,000 to a caller threatening immediate meter removal. His actual bill was already paid 3 days prior."
],
    preventionTips: [
      "Check your official bill status on your power company's website.",
      "Pay electricity bills only through official bank apps, ATM, or post offices.",
      "Never transfer utility payments to personal phone numbers."
],
    reportingGuidance: "Report extortion calls to your local DISCO consumer complaint cell and NCCIA 1799."
  },

  {
    id: "corporate-dns-hijacking",
    title: "Corporate Domain Name System (DNS) Hijacking & Cache Poisoning",
    category: "Corporate & Cloud",
    iconName: "network",
    overview: "<div class=\"article-rich-content\">\n      <h3>1. Corporate DNS Infrastructure Attacks</h3>\n      <p>In a DNS hijacking attack, cybercriminals breach domain registrar accounts or compromise DNS name servers to redirect corporate website traffic (e.g. <code>online.bank.com.pk</code>) to attacker-controlled phishing servers. Users typing the correct URL are unknowingly served fake login portals.</p>\n      <h3>2. Corporate Hardening Requirements</h3>\n      <ul>\n        <li>Enable Registrar Lock and Multi-Factor Authentication on corporate domain management accounts.</li>\n        <li>Deploy DNSSEC (Domain Name System Security Extensions) to validate DNS responses cryptographically.</li>\n      </ul>\n    </div>",
    warningSigns: [
      "Sudden SSL certificate mismatch errors when accessing company portals.",
      "Unexpected DNS IP routing changes during routine monitoring.",
      "Employees reporting inability to log into corporate web email."
],
    examples: [
      "A corporate domain registrar account was compromised using stolen employee credentials, allowing attackers to modify MX records and intercept incoming business emails."
],
    preventionTips: [
      "Enforce DNSSEC validation across all domain zones.",
      "Use multi-factor authentication on domain registrar accounts.",
      "Monitor DNS records continuously with automated change detection tools."
],
    reportingGuidance: "Report domain hijacking incidents to PKNIC registrar services and NCCIA 1799."
  },

  {
    id: "fake-loan-recovery-harassment-apps",
    title: "Instant Personal Loan App Identity Blackmail & Contact List Scraping",
    category: "Financial & Banking",
    iconName: "alert-octagon",
    overview: "<div class=\"article-rich-content\">\n      <h3>1. Illegal Loan App Exploitation</h3>\n      <p>Unregistered instant loan mobile applications target vulnerable individuals by disbursing micro-loans (Rs. 5,000 to Rs. 20,000). Upon installation, the app secretly harvests the user's full contact list, photos, and personal gallery. Within days, lenders demand 300% interest, threatening to send morphed obscene images to the victim's entire contact list if unpaid.</p>\n      <h3>2. Safety Instructions</h3>\n      <p>NEVER grant contact list or photo gallery permissions to unverified loan applications. Verify SECP licensed Non-Banking Microfinance Companies (NBFC) before taking digital loans.</p>\n    </div>",
    warningSigns: [
      "Loan app demanding full phone contact list and gallery access permissions during setup.",
      "Absence of SECP NBFC license details in app description.",
      "Exorbitant processing fees deducted before loan disbursement."
],
    examples: [
      "A student borrowed Rs. 10,000. Within a week, loan shark admins morphed his CNIC photo and broadcasted extortion messages to his entire WhatsApp contact list."
],
    preventionTips: [
      "Never download unverified loan APK files.",
      "Revoke contact list permissions in phone privacy settings.",
      "Only deal with SECP registered digital lending platforms."
],
    reportingGuidance: "Report illegal loan apps and extortion harassment to SECP, PTA, and NCCIA Cyber Crime Helpline 1799."
  },

  {
    id: "fake-blood-donor-whatsapp-groups",
    title: "Fake Emergency Blood Donation & Paid Hospital Transfusion Traps",
    category: "Urgent Threats",
    iconName: "cross",
    overview: "<div class=\"article-rich-content\">\n      <h3>1. Exploiting Medical Emergencies</h3>\n      <p>Scammers monitor social media posts for urgent rare blood group requests (A-negative, O-negative). They contact desperate family members outside hospital emergency rooms, claiming to have paid blood donors ready but demanding \"transportation / blood screening advance fees\" (Rs. 3,000 to Rs. 10,000) before switching off their phones.</p>\n      <h3>2. Verification Standard</h3>\n      <p>Only coordinate blood donations through verified blood banks (Red Crescent, Sundas Foundation, Fatimid Foundation, Husaini Blood Bank) or direct face-to-face donor meetings inside hospital premises.</p>\n    </div>",
    warningSigns: [
      "Callers demanding advance cash transfer for donor travel expenses before donor arrival at hospital.",
      "Refusal to allow direct phone conversation with the volunteer blood donor.",
      "Urgency created claiming the donor will leave if money is not sent in 10 minutes."
],
    examples: [
      "A family waiting for surgery blood transferred Rs. 6,000 to a caller promising 2 units of O-negative blood. The caller turned off his phone and no donor appeared."
],
    preventionTips: [
      "Never send advance money to unknown callers claiming to provide blood donors.",
      "Verify blood donors in person inside the hospital blood bank department.",
      "Utilize registered blood donation networks like Sundas or Fatimid."
],
    reportingGuidance: "Report extortion callers taking advantage of hospital emergencies to NCCIA 1799 and hospital security."
  },

  {
    id: "hotel-booking-portal-phishing",
    title: "Hotel Booking Confirmation Phishing & Credit Card Theft",
    category: "E-Commerce & Delivery",
    iconName: "bed",
    overview: "<div class=\"article-rich-content\">\n      <h3>1. Hotel Reservation Phishing</h3>\n      <p>Travelers booking hotel stays in Hunza, Skardu, Murree, or Karachi are targeted by fake hotel websites and spoofed chat messages on booking platforms. Scammers claim your reservation will be canceled unless you verify payment details on a phishing link.</p>\n      <h3>2. Verification Standard</h3>\n      <p>Check hotel booking confirmations directly on official hotel property phone numbers and official booking platform portals.</p>\n    </div>",
    warningSigns: [
      "Unsolicited messages on WhatsApp requesting credit card verification for hotel booking.",
      "Payment links directing to non-secure domains.",
      "Prices significantly lower than official hotel rack rates."
],
    examples: [
      "A family booked a resort in Skardu through a fake Facebook page, sending Rs. 40,000 advance. Upon arrival, the hotel management confirmed no booking existed."
],
    preventionTips: [
      "Call official hotel front desk numbers to confirm reservations before paying advances.",
      "Use recognized booking engines with buyer protection.",
      "Inspect URL structure before submitting credit card information."
],
    reportingGuidance: "Report hotel booking fraud to local tourism departments and NCCIA 1799."
  },

  {
    id: "crowdstrike-falcon-outage-incident",
    title: "The CrowdStrike Falcon Global IT & Flight Disruption Incident (2024)",
    category: "Famous Cyber Attacks",
    iconName: "server-off",
    overview: "<div class=\"article-rich-content\">\n      <h3>1. Incident Overview</h3>\n      <p>On July 19, 2024, a faulty content configuration update deployed by cybersecurity firm CrowdStrike crashed 8.5 million Microsoft Windows computers globally, causing the Blue Screen of Death (BSOD). The outage grounded thousands of international flights, halted hospital surgeries, paralyzed banking systems, and affected corporate infrastructure worldwide.</p>\n      <h3>2. Root Cause & Technical Details</h3>\n      <p>A logic flaw in a Channel File 291 update deployed to CrowdStrike's Falcon EDR sensor caused out-of-bounds memory read access, triggering kernel crashes across Windows host machines.</p>\n      <h3>3. Lessons for IT Infrastructure</h3>\n      <ul>\n        <li>Implement staged canary deployments for endpoint agent updates.</li>\n        <li>Ensure out-of-band administrative access to physical endpoint hardware.</li>\n      </ul>\n    </div>",
    warningSigns: [
      "Sudden host crashes displaying \"SYSTEM_THREAD_EXCEPTION_NOT_HANDLED\".",
      "Phishing emails claiming to offer automated CrowdStrike fix scripts containing malware."
],
    examples: [
      "Airlines, banks, and broadcast networks worldwide experienced simultaneous operational paralysis due to faulty agent updates."
],
    preventionTips: [
      "Stagger software update deployments across infrastructure tiers.",
      "Maintain verified offline backup recovery keys (BitLocker).",
      "Exercise caution against fake remediation scripts."
],
    reportingGuidance: "Follow official CrowdStrike remediation documentation and verify all patch files."
  },

  {
    id: "snowflake-cloud-database-breach",
    title: "The Snowflake Multi-Tenant Cloud Database Data Theft (2024)",
    category: "Famous Cyber Attacks",
    iconName: "database",
    overview: "<div class=\"article-rich-content\">\n      <h3>1. Incident Overview</h3>\n      <p>In mid-2024, threat actor UNC5537 targeted over 165 corporate customer accounts hosted on cloud data warehousing platform Snowflake (including Ticketmaster, Santander Bank, AT&T). Hundreds of millions of customer records were stolen and posted for extortion on dark web forums.</p>\n      <h3>2. Root Cause Analysis</h3>\n      <p>The breach was enabled by compromised contractor credentials stolen via infostealer malware, combined with customer accounts lacking Multi-Factor Authentication (MFA) and unrotated legacy session tokens.</p>\n      <h3>3. Cloud Data Protection Rules</h3>\n      <p>Enforce mandatory Multi-Factor Authentication (MFA) across all cloud database accounts and restrict IP access via network allowlists.</p>\n    </div>",
    warningSigns: [
      "Single-factor authentication enabled on corporate cloud database environments.",
      "Unusual bulk data export queries executed during off-hours.",
      "Infostealer malware infections detected on employee endpoints."
],
    examples: [
      "Attacking groups harvested plain-text credentials stored in infostealer logs to log into un-MFA protected Snowflake customer environments."
],
    preventionTips: [
      "Enforce mandatory MFA across all cloud console access.",
      "Restrict access to cloud data warehouses using IP whitelist policies.",
      "Rotate session tokens regularly."
],
    reportingGuidance: "Report cloud data breaches immediately to regulatory authorities and affected customer bases."
  },

  {
    id: "xz-utils-backdoor-supply-chain",
    title: "The XZ Utils Open Source Linux Supply Chain Backdoor (2024)",
    category: "Famous Cyber Attacks",
    iconName: "code",
    overview: "<div class=\"article-rich-content\">\n      <h3>1. Incident Overview</h3>\n      <p>In March 2024, developer Andres Freund discovered a sophisticated backdoor secretly inserted into XZ Utils (versions 5.6.0 and 5.6.1), a critical data compression utility used across Linux distributions. The multi-year social engineering operation targeted SSH authentication to grant remote code execution capabilities.</p>\n      <h3>2. Supply Chain Threat Takeaways</h3>\n      <p>Open-source software supply chains require rigorous multi-maintainer review processes and binary payload inspection tools.</p>\n    </div>",
    warningSigns: [
      "Sudden high CPU usage during SSH authentication processes.",
      "Maintainer accounts pressured into transferring project ownership.",
      "Obfuscated build scripts added to release tarballs."
],
    examples: [
      "A state-backed persona spent two years building trust in open-source repositories before injecting malicious M4 macros into release builds."
],
    preventionTips: [
      "Audit open-source dependencies regularly using automated SCA tools.",
      "Verify cryptographic signatures of release tarballs.",
      "Isolate critical SSH services using network segmentation."
],
    reportingGuidance: "Report open-source security vulnerabilities to CISA, CERT teams, and upstream maintainers."
  },

  {
    id: "change-healthcare-ransomware",
    title: "The Change Healthcare Ransomware Payment Systems Outage (2024)",
    category: "Famous Cyber Attacks",
    iconName: "activity",
    overview: "<div class=\"article-rich-content\">\n      <h3>1. Incident Overview</h3>\n      <p>In February 2024, BlackCat/ALPHV ransomware group attacked Change Healthcare (UnitedHealth Group), disabling prescription billing and medical claim processing systems across 100,000+ pharmacies and hospitals in the United States, causing over $2 billion in losses.</p>\n      <h3>2. Attack Vector</h3>\n      <p>Attackers accessed a remote desktop server lacking Multi-Factor Authentication (MFA) using stolen credentials, exfiltrating 6TB of sensitive medical data before encrypting primary data stores.</p>\n      <h3>3. Defense Blueprint</h3>\n      <p>Eliminate unauthenticated remote access entry points and maintain immutable, air-gapped backups for operational continuity.</p>\n    </div>",
    warningSigns: [
      "Remote desktop infrastructure accessible directly from the public internet without 2FA.",
      "Mass exfiltration of corporate files during weekend hours.",
      "Inability to process payment settlements."
],
    examples: [
      "Pharmacies were unable to process insurance claims, forcing patients to pay cash for vital medications due to system outages."
],
    preventionTips: [
      "Enforce MFA on all remote desktop and VPN connections.",
      "Maintain air-gapped immutable backup storage.",
      "Conduct regular ransomware recovery drills."
],
    reportingGuidance: "Report healthcare ransomware incidents immediately to federal authorities and health regulators."
  },

  {
    id: "atlassian-confluence-zero-day",
    title: "The Atlassian Confluence Remote Code Execution Vulnerabilities (2023)",
    category: "Famous Cyber Attacks",
    iconName: "cpu",
    overview: "<div class=\"article-rich-content\">\n      <h3>1. Incident Overview</h3>\n      <p>In late 2023, critical zero-day vulnerabilities (CVE-2023-22515 and CVE-2023-22518) in Atlassian Confluence Data Center and Server enabled unauthenticated attackers to create administrator accounts remotely and execute arbitrary commands across enterprise networks.</p>\n      <h3>2. Technical Remediation</h3>\n      <p>Organizations must immediately patch enterprise collaboration servers and restrict public internet exposure of administrative endpoints.</p>\n    </div>",
    warningSigns: [
      "Creation of unauthorized administrator user accounts in Confluence logs.",
      "Unusual HTTP requests to setup endpoint URLs (`/setup/*.action`)."
],
    examples: [
      "Threat actors exploited unpatched Confluence servers within hours of public disclosure to deploy ransomware across internal corporate networks."
],
    preventionTips: [
      "Apply security patches immediately upon vendor release.",
      "Restrict access to internal web tools via VPN / Zero-Trust Network Access (ZTNA).",
      "Monitor administrative account creation events."
],
    reportingGuidance: "Report zero-day exploitation events to internal SOC teams and national CERT channels."
  },

  {
    id: "okta-support-ticket-breach",
    title: "The Okta Customer Support System Session Hijack (2023)",
    category: "Famous Cyber Attacks",
    iconName: "key",
    overview: "<div class=\"article-rich-content\">\n      <h3>1. Incident Overview</h3>\n      <p>In October 2023, threat actors compromised Okta's customer support management system, gaining access to HTTP Archive (HAR) files submitted by customers. The files contained unexpired session tokens, allowing attackers to hijack session cookies of major enterprise accounts (including 1Password and Cloudflare).</p>\n      <h3>2. Security Key Takeaway</h3>\n      <p>Always sanitize HTTP Archive (HAR) files to scrub sensitive session tokens and authorization headers before sharing with third-party support desks.</p>\n    </div>",
    warningSigns: [
      "Unrecognized administrative sessions originating from unexpected geographic locations.",
      "Submission of unredacted HAR files to vendor support tickets."
],
    examples: [
      "Attackers extracted valid admin session tokens from uploaded support files to bypass 2FA authentication."
],
    preventionTips: [
      "Sanitize HAR files before uploading to external support systems.",
      "Enforce short session timeout policies for administrative portals.",
      "Monitor identity provider session creation anomalies."
],
    reportingGuidance: "Report identity provider session compromises immediately to enterprise SOC and CISO teams."
  },

  {
    id: "lastpass-cloud-vault-breach",
    title: "The LastPass Password Vault Backup Encryption Breach (2022)",
    category: "Famous Cyber Attacks",
    iconName: "lock",
    overview: "<div class=\"article-rich-content\">\n      <h3>1. Incident Overview</h3>\n      <p>In late 2022, attackers compromised a DevOps engineer's home computer via Plex media server exploit, gaining access to cloud storage keys. The attackers stole encrypted customer password vault backups along with unencrypted metadata (website URLs, company names).</p>\n      <h3>2. Defense Guidance</h3>\n      <p>Use strong 16+ character master passwords to ensure vault encryption resilience against offline brute-force attempts.</p>\n    </div>",
    warningSigns: [
      "Infostealer malware present on employee personal or home devices.",
      "Cloud storage access key exposure in developer environments."
],
    examples: [
      "Attackers used exfiltrated vault backups to attempt offline cracking of weak master passwords."
],
    preventionTips: [
      "Set strong master passwords on password manager accounts.",
      "Separate personal home devices from corporate cloud development environments.",
      "Upgrade vault iteration counts to at least 600,000 PBKDF2 iterations."
],
    reportingGuidance: "Rotate sensitive passwords stored in compromised vaults immediately."
  },

  {
    id: "solarwinds-serv-u-zero-day",
    title: "The Serv-U SSH Zero-Day Exploitation Campaign",
    category: "Famous Cyber Attacks",
    iconName: "terminal",
    overview: "<div class=\"article-rich-content\">\n      <h3>1. Incident Overview</h3>\n      <p>A critical zero-day vulnerability (CVE-2021-35211) in SolarWinds Serv-U Managed File Transfer allowed threat actors to execute remote code with elevated privileges, compromising file server data across global enterprise targets.</p>\n      <h3>2. Patching Rule</h3>\n      <p>Isolate internet-facing file transfer services and apply emergency patches to edge applications immediately.</p>\n    </div>",
    warningSigns: [
      "Unexpected child processes spawned by file transfer services.",
      "Unusual outbound network connections from MFT servers."
],
    examples: [
      "Attackers leveraged memory corruption in Serv-U SSH implementations to drop web shells on compromised host servers."
],
    preventionTips: [
      "Place file transfer systems behind Web Application Firewalls (WAF).",
      "Apply vendor patches promptly.",
      "Restrict outbound internet connectivity from file servers."
],
    reportingGuidance: "Report MFT breaches to CERT and cybersecurity emergency response units."
  },

  {
    id: "log4j-log4shell-vulnerability",
    title: "The Apache Log4j (Log4Shell) Global Zero-Day Crisis (2021)",
    category: "Famous Cyber Attacks",
    iconName: "bug",
    overview: "<div class=\"article-rich-content\">\n      <h3>1. Incident Overview</h3>\n      <p>In December 2021, the Log4Shell vulnerability (CVE-2021-44228) in Apache Log4j library impacted hundreds of millions of Java applications worldwide. Sending a single malicious JNDI string allowed attackers full remote code execution without authentication.</p>\n      <h3>2. Remediations</h3>\n      <p>Upgrade Log4j to version 2.17.1+ or set environment flag <code>log4j2.formatMsgNoLookups=true</code>.</p>\n    </div>",
    warningSigns: [
      "HTTP requests containing `${jndi:ldap://...}` patterns in user-agent or input fields.",
      "Outbound LDAP or RMI connections initiated by internal Java applications."
],
    examples: [
      "Automated scanning bots attempted Log4Shell exploitation on millions of web servers within hours of vulnerability disclosure."
],
    preventionTips: [
      "Maintain an updated Software Bill of Materials (SBOM).",
      "Deploy WAF rules to block JNDI lookup strings.",
      "Patch Java dependencies regularly."
],
    reportingGuidance: "Report Log4Shell exploitation attempts to organization SOC and infrastructure teams."
  },

  {
    id: "kaseya-vsa-supply-chain-ransomware",
    title: "The Kaseya VSA MSP Supply Chain Ransomware Attack (2021)",
    category: "Famous Cyber Attacks",
    iconName: "shield-alert",
    overview: "<div class=\"article-rich-content\">\n      <h3>1. Incident Overview</h3>\n      <p>In July 2021, REvil ransomware group exploited zero-day vulnerabilities in Kaseya VSA Remote Monitoring software used by Managed Service Providers (MSPs). The attack encrypted systems across 1,500 downstream business customers simultaneously.</p>\n      <h3>2. MSP Security Rules</h3>\n      <p>Enforce network segmentation and MFA across administrative remote monitoring platforms.</p>\n    </div>",
    warningSigns: [
      "Mass deployment of malicious encryption tasks executed via legitimate MSP management agents.",
      "Bypassing administrative authentication on MSP consoles."
],
    examples: [
      "A single compromised MSP management server resulted in hundreds of small businesses being encrypted in one afternoon."
],
    preventionTips: [
      "Isolate MSP management consoles from direct public internet exposure.",
      "Conduct regular third-party supply chain risk assessments.",
      "Maintain offline immutable backups."
],
    reportingGuidance: "Report MSP supply chain attacks to national cyber security agencies."
  },

  {
    id: "fastly-cdn-global-outage",
    title: "The Fastly Edge CDN Configuration Outage (2021)",
    category: "Famous Cyber Attacks",
    iconName: "globe-slashed",
    overview: "<div class=\"article-rich-content\">\n      <h3>1. Incident Overview</h3>\n      <p>On June 8, 2021, a single customer configuration update triggered an undiscovered bug in Fastly's edge CDN platform, causing a 85-minute global outage that took down Reddit, Amazon, Twitter, CNN, and UK government websites.</p>\n      <h3>2. High-Availability Principles</h3>\n      <p>Implement multi-CDN redundancy to maintain web availability during single-provider edge outages.</p>\n    </div>",
    warningSigns: [
      "503 Service Unavailable errors across global CDN edge nodes."
],
    examples: [
      "A valid configuration change triggered a latent software bug, causing 85% of Fastly's network to return errors."
],
    preventionTips: [
      "Deploy multi-CDN failover architecture for critical online services.",
      "Implement robust automated rollback procedures.",
      "Test edge configuration changes in staging environments."
],
    reportingGuidance: "Monitor edge platform status pages and maintain secondary DNS failover routes."
  },

  {
    id: "travelex-sodinokibi-ransomware",
    title: "The Travelex Currency Exchange Ransomware Disruption (2020)",
    category: "Famous Cyber Attacks",
    iconName: "dollar-sign",
    overview: "<div class=\"article-rich-content\">\n      <h3>1. Incident Overview</h3>\n      <p>On New Year's Eve 2019, foreign exchange company Travelex was hit by Sodinokibi/REvil ransomware. The company was forced to shut down global operations for weeks, impacting major bank FX services and leading to eventual administration.</p>\n      <h3>2. Root Cause</h3>\n      <p>Unpatched Pulse Secure VPN servers allowed attackers to breach internal networks months prior to encryption.</p>\n    </div>",
    warningSigns: [
      "Unpatched SSL VPN servers exposed to public internet.",
      "Dormant attacker activity residing inside network infrastructure."
],
    examples: [
      "Failure to patch known VPN vulnerabilities allowed attackers to gain domain administrator control and deploy ransomware globally."
],
    preventionTips: [
      "Patch perimeter SSL VPN servers immediately upon vulnerability disclosure.",
      "Perform continuous endpoint threat hunting.",
      "Isolate critical financial transactional networks."
],
    reportingGuidance: "Report enterprise ransomware disruptions to financial regulatory bodies and law enforcement."
  },

  {
    id: "capital-one-iam-misconfiguration",
    title: "AWS IAM Role Misconfiguration & Cloud Data Exposure",
    category: "Famous Cyber Attacks",
    iconName: "cloud-off",
    overview: "<div class=\"article-rich-content\">\n      <h3>1. Incident Overview</h3>\n      <p>In 2019, a former cloud engineer exploited a misconfigured Web Application Firewall (WAF) running on AWS to perform a Server-Side Request Forgery (SSRF) attack, extracting AWS IAM credentials and stealing 100 million customer credit card applications from S3 buckets.</p>\n      <h3>2. Cloud Defense Standard</h3>\n      <p>Apply the Principle of Least Privilege to AWS IAM roles and enforce IMDSv2 (Instance Metadata Service Version 2) to block SSRF credential extraction.</p>\n    </div>",
    warningSigns: [
      "Overly permissive IAM roles assigned to EC2 instances or WAF nodes.",
      "Legacy IMDSv1 enabled on cloud infrastructure.",
      "S3 bucket access logs showing mass data sync requests."
],
    examples: [
      "An SSRF flaw allowed an attacker to query the metadata service and obtain temporary access keys with read permissions to all company S3 buckets."
],
    preventionTips: [
      "Enforce IMDSv2 across all AWS EC2 instances.",
      "Restrict IAM role permissions to minimum required scopes.",
      "Scan S3 buckets for open exposure or over-permissive policies."
],
    reportingGuidance: "Report cloud IAM misconfigurations to cloud security teams and compliance officers."
  },

  {
    id: "citrix-adc-netscaler-bleed",
    title: "The Citrix NetScaler Bleed Session Cookie Hijack (2023)",
    category: "Famous Cyber Attacks",
    iconName: "shield-x",
    overview: "<div class=\"article-rich-content\">\n      <h3>1. Incident Overview</h3>\n      <p>The Citrix Bleed vulnerability (CVE-2023-4966) in Citrix ADC and NetScaler Gateway allowed unauthenticated attackers to dump system memory, exfiltrating valid session cookies and bypassing MFA to hijack active user sessions.</p>\n      <h3>2. Emergency Action</h3>\n      <p>Patch NetScaler appliances immediately and terminate all active user sessions to invalidate exfiltrated cookies.</p>\n    </div>",
    warningSigns: [
      "Unexplained session hijacking bypassing multi-factor authentication requirements.",
      "Unusual memory read requests on gateway appliances."
],
    examples: [
      "Attackers dumped active session tokens directly from gateway memory, allowing them to log in as authenticated users without triggering MFA prompts."
],
    preventionTips: [
      "Apply Citrix security patches without delay.",
      "Kill all active administrative sessions after applying patches.",
      "Monitor gateway logs for anomalous session reuse."
],
    reportingGuidance: "Report perimeter gateway compromises to national CERT bodies and SOC management."
  },

  {
    id: "3cx-desktop-supply-chain-compromise",
    title: "The 3CX Desktop App Supply Chain Trojan Incident (2023)",
    category: "Famous Cyber Attacks",
    iconName: "download",
    overview: "<div class=\"article-rich-content\">\n      <h3>1. Incident Overview</h3>\n      <p>In March 2023, state-sponsored actors compromised the official build environment of VoIP software vendor 3CX. Malicious DLL files were bundled into signed updates of the 3CX Desktop App, infecting over 600,000 corporate organizations globally in a multi-stage supply chain attack.</p>\n      <h3>2. Supply Chain Defense</h3>\n      <p>Use WebRTC browser clients instead of native desktop applications where possible, and enforce strict application whitelisting.</p>\n    </div>",
    warningSigns: [
      "Legitimate digitally signed software updates initiating shell commands.",
      "Outbound C2 beaconing from VoIP software binaries."
],
    examples: [
      "Attackers compromised a previous software vendor (Trading Technologies) to breach 3CX, demonstrating a cascading supply chain attack."
],
    preventionTips: [
      "Prefer web-based SaaS clients over desktop app installers.",
      "Implement EDR behavioral monitoring to catch anomalous child process creation.",
      "Verify digital signature certificates continuously."
],
    reportingGuidance: "Report supply chain Trojan infections immediately to enterprise SOC and CISO leadership."
  }
];

...
},
 {
  ...
  overview: `
      <div class="article-rich-content">
        ...
        <p>This scam usually follows the pattern below:</p>
        <ol>
          <li><strong>Step 1: The Fake Prize Notification:</strong> The victim receives an SMS or WhatsApp message claiming they have won a large cash prize, such as <em>"Congratulations! You have been approved to receive Rs. 25,000 under the BISP 8171 scheme. Contact us at 0300-XXXXXXX."</em></li>
  ...
  overview: `
      <div class="article-rich-content">
        ...
        <ol>
          ...
          <li><strong>Step 2: The USSD Code Request:</strong> The caller instructs you to dial a USSD code, such as <code>*786*1*1*0300XXXXXXX*5000#</code>, claiming it is required to verify your account.</li>
...

{
...

  {
    ...
    examples: [
      'SMS (appearing from official-looking header): "NADRA Alert: Aapka CNIC block ho gaya hai. Verification ke liye foran is number par rabta karein: 0300-XXXXXXX".'
    ],
    preventionTips: [
  ...
  // 12. Blackmail through Leaked Cloud Backups and Private Photos
  {
    ...
    reportingGuidance: 'Do not pay blackmailers; gather screenshots of the threats and contact the NCCIA / FIA Cyber Crime Wing (Dedicated Harassment Helpline: 1991).'
  },
